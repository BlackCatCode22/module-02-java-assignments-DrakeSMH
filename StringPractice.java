...
public class StringPractice {
    public static void main(String[] args) {
        ...
        // A method is a object-orientated language name for a function
        ...
        // Create an int variable, because the length() method returns am int.
        int myInt = 0;
